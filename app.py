...
# Optimized path discovery for modular files
...
with st.sidebar:
    ...
    if st.button("🚨 Clear Memory & Restart", use_container_width=True, type="primary"):
        st.cache_data.clear()
        st.session_state.clear()
        st.rerun()

try:
    # 1. FILE UPLOAD (Streaming Mode)
    ...
    else: st.info("Upload artworks to begin.")

except Exception as e:
    st.error("🚨 An error occurred. Please use the reset button in the sidebar.")
